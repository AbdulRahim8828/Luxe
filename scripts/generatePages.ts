...
function generateAllPageFiles(): void {
  ...
  console.log(`\n✓ Page generation complete: ${successCount}/${pagesData.length} pages`);
}
  ...
  try {
    ...
    if (autoGenStartIndex !== -1) {
      ...
      if (nextSectionMatch && nextSectionMatch.index) {
        ...
        console.log(`  ✓ Removed existing auto-generated imports`);
      }
    }
    ...
    if (routesStartIndex !== -1) {
      ...
      if (routesEndMatch && routesEndMatch.index) {
        ...
        console.log(`  ✓ Removed existing auto-generated routes`);
      }
    }
    ...
    if (!routesEndMatch) {
      ...
      console.error(`❌ Could not find </Routes> tag`);
      return;
    }
    ...
    try {
      ...
      console.log(`  ✓ Added ${stats.routesGenerated} routes to App.tsx`);
    } catch (writeError) {
      ...
      console.error(`❌ Failed to write App.tsx, restored from backup`);
    }
  } catch (error) {
...
function validatePageData(): boolean {
  ...
  if (pagesData.length !== 150) {
    ...
    console.log(`  ✓ Page count: ${pagesData.length} pages`);
  }
...
function displaySummary(): void {
  ...
  console.log(`  • Total pages in data: ${pagesData.length}`);
  console.log(`  • Files created: ${stats.filesCreated}`);
  console.log(`  • Files skipped: ${stats.filesSkipped}`);
  console.log(`  • Routes generated: ${stats.routesGenerated}`);
  ...
  console.log(`\n📈 Page Distribution:`);
  console.log(`  • Phase 1 (Mumbai generic): ${phase1Count} pages`);
  console.log(`  • Phase 2 (Location-specific): ${phase2Count} pages`);
  ...
  console.log(`\n🏷️  Title Variations:`);
  console.log(`  • Affordable: ${variationCounts.affordable} pages`);
  console.log(`  • Top-Rated: ${variationCounts['top-rated']} pages`);
  console.log(`  • Professional: ${variationCounts.professional} pages`);
  console.log(`  • Best: ${variationCounts.best} pages`);
  ...
  console.log(`  • Service categories: ${uniqueCategories}`);
  ...
  if (stats.errors.length > 0) {
    ...
    console.log(`\n📁 Generated files location: ${pagesDir}`);
    console.log(`📝 Routing updated in: ${appFilePath}`);
  }
