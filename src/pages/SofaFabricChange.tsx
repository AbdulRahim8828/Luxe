...
const SofaFabricChange: React.FC = () => {
  ...
  const serviceSchema = {
    ...
    serviceType: 'Premium Sofa Fabric Change',
    description: 'Luxury sofa fabric change and upholstery services in Mumbai. Expert craftsmanship for discerning homeowners and interior designers.',
    provider: {
      '@type': 'LocalBusiness',
