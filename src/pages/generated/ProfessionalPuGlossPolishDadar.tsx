...
const pageData: PageData = {
  ...
  "faqs": [
    {
      "question": "How much does premium pu gloss polish cost in Dadar?",
    ...
    {
      "question": "Do you provide luxury service in Dadar?",
      "answer": "Yes, we provide comprehensive luxury furniture polishing services throughout Dadar and surrounding premium areas. Our team is familiar with the luxury market in the locality and offers convenient scheduling for discerning clients. We also serve nearby upscale neighborhoods for your convenience."
    },
    {
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://luxewoodenfurniturepolishing.com/services/professional-pu-gloss-polish-dadar",
    ...
    "service": {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Professional PU Gloss Polish",
      "serviceType": "PU Gloss Polish",
      "description": "Premium professional pu gloss polish services in Dadar. Specializing in luxury furniture care for discerning homeowners and interior designers.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "Luxe Wooden Furniture Polishing",
