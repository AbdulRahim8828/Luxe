...
const pageData: PageData = {
  ...
  "faqs": [
    {
      "question": "How much does premium wood polishing cost in Borivali?",
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://luxewoodenfurniturepolishing.com/services/professional-wood-polishing-borivali",
    ...
    "service": {
      ...
      "description": "Premium professional wood polishing services in Borivali. Specializing in luxury furniture care for discerning homeowners and interior designers.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "Luxe Wooden Furniture Polishing",
