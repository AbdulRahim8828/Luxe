...
const pageData: PageData = {
  ...
  "faqs": [
    {
      "question": "How much does premium door polishing cost in Mumbai?",
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://luxewoodenfurniturepolishing.com/services/affordable-door-polishing-mumbai",
    ...
    "service": {
      ...
      "description": "Premium affordable door polishing services in Mumbai. Specializing in luxury furniture care for discerning homeowners and interior designers.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "Luxe Wooden Furniture Polishing",
