...
const pageData: PageData = {
  ...
  "faqs": [
    {
      "question": "How much does premium jhula polish cost in Goregaon?",
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://luxewoodenfurniturepolishing.com/services/top-rated-jhula-polish-goregaon",
    ...
    "service": {
      ...
      "description": "Premium top-rated jhula polish services in Goregaon. Specializing in luxury furniture care for discerning homeowners and interior designers.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "Luxe Wooden Furniture Polishing",
