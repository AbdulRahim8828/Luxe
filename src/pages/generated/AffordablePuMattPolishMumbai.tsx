...
const pageData: PageData = {
  ...
  "faqs": [
    {
      "question": "How much does premium pu matt polish cost in Mumbai?",
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://luxewoodenfurniturepolishing.com/services/affordable-pu-matt-polish-mumbai",
    ...
    "service": {
      ...
      "description": "Premium affordable pu matt polish services in Mumbai. Specializing in luxury furniture care for discerning homeowners and interior designers.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "Luxe Wooden Furniture Polishing",
