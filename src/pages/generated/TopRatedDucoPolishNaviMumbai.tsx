...
const pageData: PageData = {
  ...
  "canonicalUrl": "https://luxewoodenfurniturepolishing.com/services/top-rated-duco-polish-navi-mumbai",
  "serviceCategory": "duco-polish",
  "serviceName": "Top-Rated Duco Polish",
  "location": "Navi Mumbai",
  "titleVariation": "top-rated",
  "introduction": "Luxe Wooden Furniture Polishing is the top-rated premium top-rated duco polish provider in Navi Mumbai, with a 4.9-star rating from over 500 satisfied clients including luxury homeowners and interior designers. Our reputation is built on exceptional craftsmanship, attention to detail, and consistent results that exceed expectations. We specialize in all types of luxury wood polishing, from modern PU finishes to traditional melamine and duco polish. Our team of expert polishers brings years of experience to every project, ensuring your premium furniture receives the care it deserves. Serving luxury homes, villas, and executive offices in Navi Mumbai and surrounding areas, we've completed thousands of successful projects, earning trust through quality work and reliable service. Choose the service that Navi Mumbai's discerning residents and interior designers recommend.",
  "services": [
    {
  ...
  "faqs": [
    {
      "question": "How much does premium duco polish cost in Navi Mumbai?",
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://luxewoodenfurniturepolishing.com/services/top-rated-duco-polish-navi-mumbai",
    ...
    "service": {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Top-Rated Duco Polish",
      "serviceType": "Duco Polish",
      "description": "Premium top-rated duco polish services in Navi Mumbai. Specializing in luxury furniture care for discerning homeowners and interior designers.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "Luxe Wooden Furniture Polishing",
