...
const pageData: PageData = {
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://luxewoodenfurniturepolishing.com/services/best-dining-table-polishing-mumbai",
    ...
    "service": {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Best Dining Table Polishing",
      "serviceType": "Dining Table Polishing",
      "description": "Premium best dining table polishing services in Mumbai. Specializing in luxury furniture care for discerning homeowners and interior designers.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "Luxe Wooden Furniture Polishing",
