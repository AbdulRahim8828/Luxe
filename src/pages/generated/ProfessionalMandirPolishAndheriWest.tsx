...
const pageData: PageData = {
  ...
  "faqs": [
    {
      "question": "How much does premium mandir polish cost in Andheri West?",
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://luxewoodenfurniturepolishing.com/services/professional-mandir-polish-andheri-west",
    ...
    "service": {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Professional Mandir Polish",
      "serviceType": "Mandir Polish",
      "description": "Premium professional mandir polish services in Andheri West. Specializing in luxury furniture care for discerning homeowners and interior designers.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "Luxe Wooden Furniture Polishing",
