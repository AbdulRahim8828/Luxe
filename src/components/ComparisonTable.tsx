                ...
                <tr className="bg-gradient-to-r from-amber-50 to-orange-50">
                  ...
                  <th className="px-6 py-4 text-center">
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 bg-gradient-to-br from-amber-600 to-amber-800 rounded-lg flex items-center justify-center mb-2">
                        <span className="text-white font-bold text-lg">A1</span>
                      </div>
                      <span className="text-sm font-bold text-amber-600">A1 Furniture Polish</span>
                    </div>
                  </th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-700">
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 bg-gray-300 rounded-lg flex items-center justify-center mb-2">
